...
// 便捷方法
const openModal = (options) => traceModal.create(options);
const showConfirm = (options) => traceModal.confirm(options);
const showAlert = (options) => traceModal.alert(options);
...
// CommonJS导出
module.exports.traceModal = traceModal;
