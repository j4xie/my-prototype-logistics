...
function makeConfigResponse(overrides: Record<string, unknown> = {}) {
  return {
    ...
    diffThreshold: 0.30,
    sourcePriorities: [
      { sourceType: 'manual', name: '客户手动确认', globalDefault: 1, factoryOverride: null },
      { sourceType: 'bill_flow', name: '账单流水', globalDefault: 2, factoryOverride: null },
      { sourceType: 'product_summary', name: '商品汇总', globalDefault: 3, factoryOverride: null },
      { sourceType: 'review', name: '评论数据', globalDefault: 4, factoryOverride: null },
      { sourceType: 'inferred', name: 'AI 推断', globalDefault: 5, factoryOverride: null },
      { sourceType: 'industry_default', name: '行业默认值', globalDefault: 6, factoryOverride: null },
    ],
    industryDefaults: [
      { category: '川菜', name: '川菜', globalDefault: 0.35, override: null },
      { category: '粤菜', name: '粤菜', globalDefault: 0.40, override: null },
      { category: '湘菜', name: '湘菜', globalDefault: 0.32, override: null },
      { category: '火锅', name: '火锅', globalDefault: 0.28, override: null },
    ],
