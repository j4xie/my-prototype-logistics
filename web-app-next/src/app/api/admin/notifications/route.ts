...
// Original file backed up and disabled on: 2025-06-04T04:13:26.037Z
...
// notifications/[id] API路由
// 生成时间: 2025-06-03T14:10:37.514Z
// 模块: admin
// 实体: Notification
...
export async function GET(_request: NextRequest) {
  try {
    ...
    console.error('GET /admin/notifications/[id] error:', error);
    return NextResponse.json({
      success: false,
...
export async function PUT(_request: NextRequest) {
  try {
    ...
    console.error('PUT /admin/notifications/[id] error:', error);
    return NextResponse.json({
      success: false,
      message: 'Internal Server Error',
      timestamp: new Date().toISOString()
