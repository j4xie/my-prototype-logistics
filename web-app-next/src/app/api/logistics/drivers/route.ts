...
// Original file backed up and disabled on: 2025-06-04T04:13:25.859Z
...
export async function GET(_request: NextRequest) {
  try {
    ...
    console.error('GET /logistics/drivers/[id] error:', error);
    return NextResponse.json({
      success: false,
...
export async function PUT(_request: NextRequest) {
  try {
    ...
    console.error('PUT /logistics/drivers/[id] error:', error);
    return NextResponse.json({
      success: false,
      message: 'Internal Server Error',
      timestamp: new Date().toISOString()
...
export async function DELETE(_request: NextRequest) {
  try {
    ...
    console.error('DELETE /logistics/drivers/[id] error:', error);
    return NextResponse.json({
      success: false,
      message: 'Internal Server Error',
      timestamp: new Date().toISOString()
