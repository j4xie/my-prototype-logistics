            ...
            <div className="ml-3 flex-1">
              ...
              <div className="mt-3 space-y-3">
                ...
                <div className="p-3 bg-purple-100 rounded-lg border border-purple-200">
                  ...
                  <div className="text-xs text-purple-700 mb-2">最高权限，可管理所有工厂租户和平台运营</div>
                  <div className="space-y-2">
                    <div className="flex items-center justify-between bg-white rounded p-2 border">
                      <div className="flex items-center space-x-2">
                        ...
                        <code className="font-mono text-sm text-purple-800">super_admin</code>
                      </div>
                      <div className="flex space-x-1">
                        <button
                          type="button"
                          onClick={() => copyToClipboard('super_admin', 'super_admin_username')}
                          className="p-1 text-purple-600 hover:text-purple-800 transition-colors"
                        >
                          {copiedField === 'super_admin_username' ? (
                    ...
                    <div className="flex items-center justify-between bg-white rounded p-2 border">
                      <div className="flex items-center space-x-2">
                        ...
                        <code className="font-mono text-sm text-purple-800">super123</code>
                      </div>
                      <div className="flex space-x-1">
                        <button
                          type="button"
                          onClick={() => copyToClipboard('super123', 'super_admin_password')}
                          className="p-1 text-purple-600 hover:text-purple-800 transition-colors"
                        >
                          {copiedField === 'super_admin_password' ? (
                            <CheckCheck className="w-3 h-3 text-green-600" />
                          ) : (
                            <Copy className="w-3 h-3" />
                          )}
                    ...
                    <button
                      type="button"
                      onClick={() => quickFill('super_admin', 'super123')}
                ...
                <div className="p-3 bg-blue-100 rounded-lg border border-blue-200">
                  ...
                  <div className="text-xs text-blue-700 mb-2">工厂内部统一账号，具有完整管理权限</div>
                  <div className="space-y-2">
                    <div className="flex items-center justify-between bg-white rounded p-2 border">
                      <div className="flex items-center space-x-2">
                        <span className="text-blue-600 text-xs">用户名：</span>
                        <code className="font-mono text-sm text-blue-800">user</code>
                      </div>
                      <div className="flex space-x-1">
                        <button
                          type="button"
                          onClick={() => copyToClipboard('user', 'user_username')}
                          className="p-1 text-blue-600 hover:text-blue-800 transition-colors"
                        >
                          {copiedField === 'user_username' ? (
                            <CheckCheck className="w-3 h-3 text-green-600" />
                          ) : (
                            <Copy className="w-3 h-3" />
                          )}
                    ...
                    <div className="flex items-center justify-between bg-white rounded p-2 border">
                      <div className="flex items-center space-x-2">
                        ...
                        <code className="font-mono text-sm text-blue-800">user123</code>
                      </div>
                      <div className="flex space-x-1">
                        <button
                          type="button"
                          onClick={() => copyToClipboard('user123', 'user_password')}
                          className="p-1 text-blue-600 hover:text-blue-800 transition-colors"
                        >
                          {copiedField === 'user_password' ? (
                            <CheckCheck className="w-3 h-3 text-green-600" />
                          ) : (
                            <Copy className="w-3 h-3" />
                          )}
                    ...
                    <button
                      type="button"
                      onClick={() => quickFill('user', 'user123')}
