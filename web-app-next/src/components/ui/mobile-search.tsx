...
// TypeScript接口定义
export interface MobileSearchProps extends Omit<React.InputHTMLAttributes<HTMLInputElement>, 'onChange' | 'onFocus' | 'onBlur'> {
  placeholder?: string;
  value?: string;
    ...
    >
      ...
      <div className={cn(
        ...
        {localValue && (
          <button
            ...
            aria-label="清除搜索内容"
            className={cn(
              'p-2 mr-1 rounded transition-colors duration-200',
              'focus:outline-none focus:ring-2 focus:ring-[#1890FF] focus:ring-offset-1',
        ...
        {showCancelButton && isExpanded && (
          <button
            ...
            className={cn(
              'px-3 py-2 text-sm text-[#1890FF] font-medium rounded transition-colors duration-200',
      ...
      {isExpanded && (isFocused || localValue) && (
        <div 
          ...
          className="mt-2 bg-white rounded-lg shadow-lg border border-gray-200 max-h-80 overflow-y-auto"
          role="listbox"
        >
          {/* 搜索建议 */}
              ...
              {filteredSuggestions.map((suggestion, index) => (
                <button
                  ...
                  className={cn(
                    ...
                    'hover:bg-gray-50 active:bg-gray-100 focus:bg-gray-50',
                    'focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[#1890FF]'
                  )}
                  role="option"
                  aria-selected={false}
                >
              ...
              <div className="flex items-center justify-between px-4 py-2 border-b border-gray-100">
                ...
                {onClearHistory && (
                  <button
                    ...
                    className={cn(
                      'text-xs text-[#1890FF] px-2 py-1 rounded transition-colors duration-200',
                      'hover:bg-blue-50 active:bg-blue-100',
                      'focus:outline-none focus:ring-2 focus:ring-[#1890FF] focus:ring-offset-1'
                    )}
                  >
...
export const QuickSearchBar: React.FC<QuickSearchBarProps> = ({
  ...
  return (
    <button
      ...
      className={cn(
        'flex items-center bg-gray-100 rounded-lg px-3 py-2 w-full max-w-[390px] mx-auto transition-colors duration-200',
        'hover:bg-gray-200 active:bg-gray-300',
        'focus:outline-none focus:ring-2 focus:ring-[#1890FF] focus:ring-offset-2',
        className
      )}
