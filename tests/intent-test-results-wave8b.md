...
--- AA8: 行业术语-供应链制造业 (6) ---
  ...
  V [QUERY   ] SUPPLIER_PRICE_COMPARISON      LLM          0.64 | FOB价格查询
...
--- AE2: 秤-故障排查与校准 (5) ---
  ...
  T [UNKNOWN ] SCALE_READING_ANOMALY          LLM          0.70 | 电子秤读数异常
...
--- AM1: 餐饮-写入操作 (5) ---
  ...
  I [WRITE   ] SHIPMENT_CREATE                LLM          0.60 | 今天的食材采购单生成一下
  === AM1: intent=3/5, type=3/5
...
--- AU1: 系统-翻页/返回/切换 (6) ---
  T [UNKNOWN ] INTENT_ANALYZE                 LLM          0.60 | 下一页
  ...
  V [QUERY   ] REPORT_DASHBOARD_OVERVIEW      LLM          0.60 | 换一个看看
  === AU1: intent=4/6, type=4/6
...
--- AX1: 质检合格/不合格精确路由 (7) ---
  ...
  V [QUERY   ] REPORT_QUALITY                 LLM          0.67 | 今天合格了几个批次
...
--- Y2: 对抗-隐晦意图表达 (5) ---
  ...
  T [UNKNOWN ] WAREHOUSE_CAPACITY_ALERT       LLM          0.68 | 仓库放不下了
...
--- Z7: 数量条件-区间范围 (5) ---
  ...
  V [QUERY   ] QUERY_EMPLOYEE_PROFILE         LLM          0.60 | 月薪8000以上的员工
...
!!! 89 TYPE CONFUSIONS (cross-contamination) !!!
  ...
  [AU1] "下一页" expected=QUERY|WRITE actual=UNKNOWN intent=INTENT_ANALYZE (翻页-下一页)
...
--- 19 Intent Mismatches ---
  ...
  [AM1] [LLM] "今天的食材采购单生成一下" -> SHIPMENT_CREATE, expected: RESTAURANT_PROCUREMENT_CREATE|ORDER_NEW|FORM_GENERATION|N/A (生成采购单)
  ...
  [AU1] [LLM] "下一页" -> INTENT_ANALYZE, expected: PAGINATION_NEXT|CONTEXT_CONTINUE|CONDITION_SWITCH|REPORT_DASHBOARD_OVERVIEW|N/A (翻页-下一页)
...
======================================================================
PHASE 2: Response Quality (00:22:26)
======================================================================
  ...
  ~ [QUERY  ] SHIPMENT_CREATE                | 今日订单     | WARN:status=NEED_CLARIFICATION, OK:has_reply, WARN:no_data, OK:relevant(1/1kw)
    reply: 用户提到'今天有新订单'，在出货物流的语境下，这通常意味着需要基于新订单执行发货操作，即创建新的发货单。虽然语句简短，但隐含了启动发货流程的意图，与'SHIPMENT_CREATE (创建发货单)'的
  ...
  V [QUERY  ] TRACE_FULL                     | 猪肉溯源     | OK:slot_filling, OK:has_reply, OK:relevant(2/3kw), OK:time(18s)
  ...
  V [WRITE  ] CLOCK_OUT                      | 签退打卡     | OK:slot_filling, OK:has_reply, OK:has_data, OK:relevant(1/1kw)
    reply: 签退成功！您今天提前275分钟下班。今日工作时长：4.4小时。
  ...
  ~ [WRITE  ] OUT_OF_DOMAIN                  | 打开摄像头    | WARN:status=NEED_CLARIFICATION, OK:has_reply, OK:relevant(1/1kw)
    reply: 用户指令'打开摄像头'属于硬件控制或通用设备操作请求。在提供的意图列表中，主要涵盖工厂系统的业务逻辑（如排产、通知、配置、应急处理等），没有任何意图支持直接控制物理摄像头硬件或启动视频流功能。虽然存在
...
Started at 00:24:41
======================================================================
  ... 50/1232 done (00:24:50)
  ... 100/1232 done (00:24:58)
  ... 150/1232 done (00:25:08)
  ... 200/1232 done (00:25:18)
  ... 250/1232 done (00:25:31)
  ... 300/1232 done (00:25:40)
  ... 350/1232 done (00:25:49)
  ... 400/1232 done (00:26:01)
  ... 450/1232 done (00:26:14)
  ... 500/1232 done (00:26:23)
  ... 550/1232 done (00:26:36)
  ... 600/1232 done (00:26:49)
  ... 650/1232 done (00:26:57)
  ... 700/1232 done (00:27:01)
  ... 750/1232 done (00:27:06)
  ... 800/1232 done (00:27:11)
  ... 850/1232 done (00:27:17)
  ... 900/1232 done (00:27:22)
  ... 950/1232 done (00:27:28)
  ... 1000/1232 done (00:27:33)
  ... 1050/1232 done (00:27:40)
  ... 1100/1232 done (00:27:49)
  ... 1150/1232 done (00:27:57)
  ... 1200/1232 done (00:28:05)
  Completed all 1232 at 00:28:17
...
Categories needing attention: AG2, AL1, AO3, AU2, U4, Z4
