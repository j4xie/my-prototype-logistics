...
--- AA8: 行业术语-供应链制造业 (6) ---
  ...
  I [QUERY   ] SUPPLIER_SEARCH                LLM          0.60 | FOB价格查询
...
--- AB12: 溯源-生成二维码追溯码 (5) ---
  ...
  I [QUERY   ] OUT_OF_DOMAIN                  LLM          0.64 | 溯源码是什么格式的
  === AB12: intent=4/5, type=3/5
...
--- AF1: 报工-进度与工时查询 (5) ---
  I [QUERY   ] TRACE_BATCH                    SEMANTIC     0.99 | 查看生产进度报告
...
--- AG3: 告警-分诊诊断 (5) ---
  V [QUERY   ] ALERT_DIAGNOSE                 LLM          0.69 | 帮我分析一下这个告警的原因
...
--- AN1: 多轮-接上条/继续查 (6) ---
  ...
  T [QUERY   ] DATA_BATCH_DELETE              LLM          0.44 | 把刚才的结果导出
...
--- AO1: 安全-SQL注入模式 (5) ---
  ...
  V [QUERY   ] DATA_BATCH_DELETE              LLM          0.68 | Robert'); DROP TABLE production;--
...
--- AP2: 数字-日期运算 (5) ---
  ...
  I [WRITE   ] PROCESSING_BATCH_COMPLETE      LLM          0.64 | 下周一之前要完成的订单
  === AP2: intent=4/5, type=5/5

--- AP3: 数字-多数值组合查询 (5) ---
  V [QUERY   ] REPORT_PRODUCTION              PHRASE_MATCH 0.98 | 3号车间2月15号生产了多少
  V [QUERY   ] QUALITY_CHECK_QUERY            SEMANTIC     0.93 | 查看批次号B001到B010的质检
...
--- AS2: 情绪-紧急恐慌 (5) ---
  ...
  V [QUERY   ] SHIPMENT_QUERY                 SEMANTIC     0.85 | 客户催了三次了赶紧查发货
...
--- AX2: 入库/出库/调拨精确区分 (7) ---
  ...
  T [QUERY   ] WAREHOUSE_OUTBOUND             LLM          0.56 | 把这批货从待检区移到成品库
  V [QUERY   ] REPORT_INVENTORY               LLM          0.67 | 今天入了多少出了多少
  === AX2: intent=7/7, type=5/7
...
--- AX4: 摄像头启动与配置 (6) ---
  ...
  V [WRITE   ] FACTORY_FEATURE_TOGGLE         LLM          0.64 | 把车间摄像头关了
  === AX4: intent=5/6, type=4/6
...
--- V3: 写入-通知消息 (4) ---
  ...
  V [WRITE   ] USER_CREATE                    LLM          0.60 | 通知所有人开会
...
--- Z4: 代码混用-网络用语 (5) ---
  ...
  V [QUERY   ] REPORT_DASHBOARD_OVERVIEW      LLM          0.64 | 整个report给老板
...
======================================================================
Intent accuracy:  1217/1232 (99%)
Type accuracy:    1147/1232 (93%)
...
!!! 85 TYPE CONFUSIONS (cross-contamination) !!!
  ...
  [AX2] "把这批货从待检区移到成品库" expected=WRITE actual=QUERY intent=WAREHOUSE_OUTBOUND (调拨-区域)
...
--- 15 Intent Mismatches ---
  [AA8] [LLM] "FOB价格查询" -> SUPPLIER_SEARCH, expected: SUPPLIER_PRICE_COMPARISON|ORDER_LIST|COST_QUERY|REPORT_DASHBOARD_OVERVIEW|N/A (FOB=离岸价)
  [AB12] [LLM] "溯源码是什么格式的" -> OUT_OF_DOMAIN, expected: FOOD_KNOWLEDGE_QUERY|TRACE_PUBLIC|REPORT_DASHBOARD_OVERVIEW|N/A (溯源格式咨询)
  [AF1] [SEMANTIC] "查看生产进度报告" -> TRACE_BATCH, expected: PRODUCTION_PROGRESS_REPORT|REPORT_PRODUCTION|PROCESSING_BATCH_LIST|N/A (进度报告)
  ...
  [AP2] [LLM] "下周一之前要完成的订单" -> PROCESSING_BATCH_COMPLETE, expected: ORDER_LIST|ORDER_TIMEOUT_MONITOR|ORDER_STATUS|SHIPMENT_STATUS_UPDATE|N/A (未来日期-截止)
...
======================================================================
PHASE 2: Response Quality (21:01:48)
======================================================================
  ...
  V [WRITE  ] CLOCK_OUT                      | 签退打卡     | OK:slot_filling, OK:has_reply, OK:has_data, OK:relevant(1/1kw)
    reply: 签退成功！您今天提前476分钟下班。今日工作时长：1.1小时。
  ...
  ~ [WRITE  ] OUT_OF_DOMAIN                  | 打开摄像头    | WARN:status=NEED_CLARIFICATION, OK:has_reply, OK:relevant(1/1kw), OK:time(11s)
    reply: 用户指令'打开摄像头'属于硬件控制或通用设备操作请求。在提供的意图列表中，没有针对'摄像头控制'、'视频监控开启'或'硬件设备开关'的特定意图。虽然存在'功能开关 (FACTORY_FEATURE_T

--- Phase 2 Summary ---
Total: 94 | PASS: 69 | WARN: 25 | FAIL: 0
Pass rate: 69/94 (73%) full-pass
...
FINAL SUMMARY
======================================================================
Phase 1 - Intent Routing:  1217/1232 (99%)
Phase 1 - Type Separation: 1147/1232 (93%)
Phase 1 - Cross-contamination: 85 cases
Phase 2 - Response Quality: 69/94 full-pass, 94/94 acceptable
...
Started at 21:03:39
======================================================================
  ... 50/1232 done (21:03:54)
  ... 100/1232 done (21:04:01)
  ... 150/1232 done (21:04:09)
  ... 200/1232 done (21:04:14)
  ... 250/1232 done (21:04:24)
  ... 300/1232 done (21:04:29)
  ... 350/1232 done (21:04:35)
  ... 400/1232 done (21:04:47)
  ... 450/1232 done (21:04:56)
  ... 500/1232 done (21:05:02)
  ... 550/1232 done (21:05:12)
  ... 600/1232 done (21:05:22)
  ... 650/1232 done (21:05:28)
  ... 700/1232 done (21:05:32)
  ... 750/1232 done (21:05:37)
  ... 800/1232 done (21:05:49)
  ... 850/1232 done (21:05:54)
  ... 900/1232 done (21:05:57)
  ... 950/1232 done (21:06:00)
  ... 1000/1232 done (21:06:03)
  ... 1050/1232 done (21:06:18)
  ... 1100/1232 done (21:06:23)
  ... 1150/1232 done (21:06:29)
  ... 1200/1232 done (21:06:35)
  Completed all 1232 at 21:06:45
...
Categories needing attention: AO3, AU2, U4, Z4
...
======================================================================
Phase 1  — Intent Routing:      1217/1232 (99%)
Phase 2  — Curated Quality:     69/94 full-pass, 94/94 acceptable
