...
--- AA8: 行业术语-供应链制造业 (6) ---
  ...
  I [QUERY   ] SHIPMENT_QUERY                 LLM          0.60 | FOB价格查询
...
--- AM3: 餐饮-经营诊断分析 (5) ---
  ...
  T [UNKNOWN ] REPORT_FINANCE_REVENUE         LLM          0.60 | 人均消费是多少
...
--- AO1: 安全-SQL注入模式 (5) ---
  ...
  I [QUERY   ] DATA_BATCH_DELETE              LLM          0.68 | Robert'); DROP TABLE production;--
...
--- AQ1: 公文-正式查询用语 (5) ---
  ...
  V [QUERY   ] EQUIPMENT_MAINTENANCE          LLM          0.64 | 兹需查阅设备维保记录以便存档
...
--- AW1: 生产工序/工人深层查询 (7) ---
  ...
  I [QUERY   ] PROCESSING_BATCH_DETAIL        LLM          0.64 | 目前到了哪一步
  === AW1: intent=5/7, type=7/7
...
--- AX4: 摄像头启动与配置 (6) ---
  ...
  I [WRITE   ] FACTORY_FEATURE_TOGGLE         LLM          0.64 | 把车间摄像头关了
  === AX4: intent=3/6, type=4/6
...
--- E5: 查询-溯源/追溯 (4) ---
  ...
  I [QUERY   ] QUERY_GENERIC_DETAIL           LLM          0.64 | 溯源码查询
...
--- U4: 写入-工人管理操作 (4) ---
  ...
  I [WRITE   ] USER_ROLE_ASSIGN               LLM          0.67 | 把李四安排到包装岗位
  === U4: intent=3/4, type=3/4
...
--- Z4: 代码混用-网络用语 (5) ---
  ...
  I [QUERY   ] REPORT_EXECUTIVE_DAILY         LLM          0.64 | 整个report给老板
...
Type accuracy:    1138/1232 (92%)

!!! 94 TYPE CONFUSIONS (cross-contamination) !!!
  ...
  [AM3] "人均消费是多少" expected=QUERY actual=UNKNOWN intent=REPORT_FINANCE_REVENUE (人均消费)
...
--- 56 Intent Mismatches ---
  ...
  [AA8] [LLM] "FOB价格查询" -> SHIPMENT_QUERY, expected: SUPPLIER_PRICE_COMPARISON|ORDER_LIST|COST_QUERY|REPORT_DASHBOARD_OVERVIEW|N/A (FOB=离岸价)
  ...
  [AC4] [LLM] "损耗最高的食材" -> MATERIAL_LOSS_RANKING, expected: RESTAURANT_WASTAGE_ANOMALY|RESTAURANT_WASTAGE_SUMMARY|RESTAURANT_WASTAGE_RATE|REPORT_KPI|N/A (损耗排名)
  ...
  [AH15] [LLM] "损耗太大了要查原因" -> WASTAGE_ROOT_CAUSE_ANALYSIS, expected: RESTAURANT_WASTAGE_ANOMALY|REPORT_ANOMALY|QUALITY_STATS|ALERT_DIAGNOSE|N/A (损耗歧义)
  ...
  [AM3] [LLM] "人均消费是多少" -> REPORT_FINANCE_REVENUE, expected: RESTAURANT_AVG_TICKET|REPORT_KPI|CUSTOMER_STATS|REPORT_DASHBOARD_OVERVIEW|N/A (人均消费)
  ...
  [AU1] [LLM] "下一页" -> CONDITION_SWITCH, expected: PAGINATION_NEXT|CONTEXT_CONTINUE|N/A (翻页-下一页)
  ...
  [AW1] [LLM] "目前到了哪一步" -> PROCESSING_BATCH_DETAIL, expected: QUERY_PROCESSING_CURRENT_STEP|QUERY_PROCESSING_STEP|CONTEXT_CONTINUE|PROCESSING_BATCH_TIMELINE|N/A (工序-哪一步)
  ...
  [E5] [LLM] "溯源码查询" -> QUERY_GENERIC_DETAIL, expected: TRACE_PUBLIC|TRACE_BATCH (溯源码)
  [T1] [SEMANTIC] "增加值怎么计算" -> MRP_CALCULATION, expected: FOOD_KNOWLEDGE_QUERY|REPORT_KPI|REPORT_FINANCE|N/A (增加值≠增加,可UNMATCHED)
  [U4] [LLM] "把李四安排到包装岗位" -> USER_ROLE_ASSIGN, expected: TASK_ASSIGN_BY_NAME|TASK_ASSIGN_EMPLOYEE|TASK_ASSIGN_WORKER|PROCESSING_WORKER_ASSIGN|N/A (按名分配,人名可能阻断匹配)
  ...
  [Z4] [LLM] "整个report给老板" -> REPORT_EXECUTIVE_DAILY, expected: REPORT_DASHBOARD_OVERVIEW|REPORT_KPI|REPORT_PRODUCTION|N/A (report=报表)

======================================================================
PHASE 2: Response Quality (18:27:40)
======================================================================
  ...
  V [QUERY  ] TRACE_FULL                     | 猪肉溯源     | OK:slot_filling, OK:has_reply, OK:relevant(2/3kw), OK:time(14s)
  ...
  V [WRITE  ] CLOCK_OUT                      | 签退打卡     | OK:slot_filling, OK:has_reply, OK:has_data, OK:relevant(1/1kw)
    reply: 签退成功！您今天提前631分钟下班。今日工作时长：-1.5小时。
  ...
  ~ [WRITE  ] OPEN_CAMERA                    | 打开摄像头    | WARN:status=NEED_CLARIFICATION, OK:has_reply, OK:relevant(1/1kw)
    reply: 用户指令'打开摄像头'直接对应启动或启用摄像头设备的操作。在可用意图中，'OPEN_CAMERA'的描述为'启动或启用工厂内的摄像头设备'，且关键词包含'打开相机'、'启动摄像头'，与用户语义完全匹配

--- Phase 2 Summary ---
Total: 94 | PASS: 76 | WARN: 18 | FAIL: 0
Pass rate: 76/94 (81%) full-pass
...
Phase 1 - Type Separation: 1138/1232 (92%)
Phase 1 - Cross-contamination: 94 cases
Phase 2 - Response Quality: 76/94 full-pass, 94/94 acceptable
...
Started at 18:29:08
======================================================================
  ... 50/1232 done (18:29:15)
  ... 100/1232 done (18:29:20)
  ... 150/1232 done (18:29:26)
  ... 200/1232 done (18:29:30)
  ... 250/1232 done (18:29:37)
  ... 300/1232 done (18:29:42)
  ... 350/1232 done (18:29:53)
  ... 400/1232 done (18:30:02)
  ... 450/1232 done (18:30:10)
  ... 500/1232 done (18:30:15)
  ... 550/1232 done (18:30:22)
  ... 600/1232 done (18:30:31)
  ... 650/1232 done (18:30:36)
  ... 700/1232 done (18:30:39)
  ... 750/1232 done (18:30:42)
  ... 800/1232 done (18:30:45)
  ... 850/1232 done (18:30:48)
  ... 900/1232 done (18:30:51)
  ... 950/1232 done (18:30:55)
  ... 1000/1232 done (18:30:57)
  ... 1050/1232 done (18:31:01)
  ... 1100/1232 done (18:31:05)
  ... 1150/1232 done (18:31:10)
  ... 1200/1232 done (18:31:15)
  Completed all 1232 at 18:31:24
...
--- FAIL Cases (9) ---
  ...
  [AI3] "设备故樟" → N/A | status=? | API_ERROR, NO_REPLY
    reply: (empty)
...
======================================================================
Total: 1232 | PASS: 1223 (99%) | WARN: 0 | FAIL: 9
Acceptable (PASS+WARN): 1223/1232 (99%)
Categories needing attention: AG2, AI3, AO3, AU2, U4, Z4
...
======================================================================
Phase 1  — Intent Routing:      1176/1232 (95%)
Phase 2  — Curated Quality:     76/94 full-pass, 94/94 acceptable
Phase 2b — Full Quality Scan:   1223/1232 full-pass (99%), 1223/1232 acceptable (99%)
