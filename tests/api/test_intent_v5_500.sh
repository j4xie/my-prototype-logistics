...
# 生产类 (10)
test_intent "今日生产进度" "REPORT_PRODUCTION" "A-生产"
test_intent "当天产量多少" "REPORT_PRODUCTION" "A-生产"
test_intent "今天做了多少" "REPORT_PRODUCTION" "A-生产"
...
test_intent "称重记录查询" "SCALE_LIST_DEVICES" "A-秤"
...
test_intent "秤的称重数据" "SCALE_LIST_DEVICES" "A-秤"
test_intent "最近称重记录" "SCALE_LIST_DEVICES" "A-秤"
...
test_intent "告警情况" "ALERT_LIST" "B-告警"
test_intent "告警统计" "ALERT_STATS" "B-告警"
test_intent "历史告警" "ALERT_LIST" "B-告警"
test_intent "告警记录" "ALERT_LIST" "B-告警"
...
test_intent "设备状态和告警" "EQUIPMENT_STATS" "B-组合"
...
test_intent "机器有事儿没" "EQUIPMENT_STATS" "C-口语"
test_intent "秤好使不" "SCALE_DEVICE_DETAIL" "C-口语"
test_intent "质量咋样" "QUALITY_STATS" "C-口语"
test_intent "今儿干了多少" "REPORT_PRODUCTION" "C-口语"
test_intent "告警有没有" "ALERT_LIST" "C-口语"
...
test_intent "机子转着呢吗" "EQUIPMENT_STATS" "C-口语"
test_intent "单子出了没" "SHIPMENT_QUERY" "C-口语"

# C031-045: 语义区分 (15)
test_intent "设备状况" "EQUIPMENT_STATS" "C-区分"
test_intent "设备问题" "EQUIPMENT_ALERT_LIST" "C-区分"
...
test_intent "告警情况" "ALERT_LIST" "C-区分"
test_intent "告警问题" "ALERT_LIST" "C-区分"
...
test_intent "MES状态" "EQUIPMENT_STATS" "C-术语"
...
test_intent "AGV状态" "EQUIPMENT_STATS" "C-术语"
test_intent "PLC数据" "EQUIPMENT_STATS" "C-术语"
test_intent "SCADA监控" "EQUIPMENT_STATS" "C-术语"
...
# E007-012: ALERT领域 (6)
test_intent "告警" "ALERT_LIST" "E-领域"
test_intent "预警" "ALERT_LIST" "E-领域"
test_intent "警报" "ALERT_LIST" "E-领域"
test_intent "异常" "ALERT_LIST" "E-领域"
test_intent "报警" "ALERT_LIST" "E-领域"
test_intent "告警信息" "ALERT_LIST" "E-领域"
...
test_intent "加工" "PROCESSING_BATCH_LIST" "E-领域"
test_intent "产量" "REPORT_PRODUCTION" "E-领域"
test_intent "产出" "REPORT_PRODUCTION" "E-领域"
...
test_intent "添加设备" "EQUIPMENT_LIST" "F-操作"
test_intent "新增原料" "MATERIAL_BATCH_QUERY" "F-操作"
...
# F017-024: UPDATE操作 (8)
test_intent "修改设备" "EQUIPMENT_STATUS_UPDATE" "F-操作"
test_intent "更新批次" "PROCESSING_BATCH_DETAIL" "F-操作"
test_intent "调整原料" "MATERIAL_BATCH_QUERY" "F-操作"
test_intent "编辑发货" "SHIPMENT_UPDATE" "F-操作"
test_intent "变更质检" "QUALITY_CHECK_QUERY" "F-操作"
test_intent "设置告警" "RULE_CONFIG" "F-操作"
test_intent "改生产" "PROCESSING_BATCH_DETAIL" "F-操作"
test_intent "更改状态" "EQUIPMENT_STATS" "F-操作"

# F025-030: DELETE操作 (6)
test_intent "删除设备" "SCALE_DELETE_DEVICE" "F-操作"
test_intent "取消批次" "PROCESSING_BATCH_CANCEL" "F-操作"
test_intent "作废发货" "SHIPMENT_UPDATE" "F-操作"
...
test_clarify "如何提高产量" "COMPLETED" "G-问题"
test_clarify "为什么效率低" "COMPLETED" "G-问题"
test_clarify "什么是FIFO" "COMPLETED" "G-问题"
test_clarify "怎么优化生产" "COMPLETED" "G-问题"
test_clarify "为何质量下降" "COMPLETED" "G-问题"
test_clarify "如何减少浪费" "COMPLETED" "G-问题"
test_clarify "什么影响产能" "COMPLETED" "G-问题"
test_clarify "怎样提升效率" "COMPLETED" "G-问题"
test_clarify "为什么会报警" "COMPLETED" "G-问题"
test_clarify "如何改善质量" "COMPLETED" "G-问题"

# G011-020: CONVERSATIONAL (10)
test_clarify "你好" "COMPLETED" "G-闲聊"
test_clarify "谢谢" "COMPLETED" "G-闲聊"
test_clarify "在吗" "COMPLETED" "G-闲聊"
test_clarify "你是谁" "COMPLETED" "G-闲聊"
test_clarify "帮帮我" "COMPLETED" "G-闲聊"
test_clarify "明白了" "COMPLETED" "G-闲聊"
test_clarify "好的" "COMPLETED" "G-闲聊"
test_clarify "收到" "COMPLETED" "G-闲聊"
test_clarify "辛苦了" "COMPLETED" "G-闲聊"
test_clarify "再见" "COMPLETED" "G-闲聊"
...
test_intent "看告警" "ALERT_LIST" "G-指令"
...
test_intent "设备状态" "EQUIPMENT_STATS" "H-高置信"
...
test_intent "今日生产" "REPORT_PRODUCTION" "H-高置信"
...
test_clarify "今天天气怎么样" "COMPLETED" "H-低置信"
test_clarify "明天会下雨吗" "COMPLETED" "H-低置信"
test_clarify "你觉得呢" "COMPLETED" "H-低置信"
test_clarify "随便聊聊" "COMPLETED" "H-低置信"
test_clarify "有意思" "COMPLETED" "H-低置信"
test_clarify "无聊了" "COMPLETED" "H-低置信"
test_clarify "讲个笑话" "COMPLETED" "H-低置信"
test_clarify "唱首歌" "COMPLETED" "H-低置信"
test_clarify "写首诗" "COMPLETED" "H-低置信"
test_clarify "聊聊天" "COMPLETED" "H-低置信"

# H031-040: 边界值测试 (10)
test_intent "设备情况怎么样" "EQUIPMENT_STATS" "H-边界"
...
test_intent "告警严重吗" "ALERT_LIST" "H-边界"
...
test_intent "查看今日的产量数据" "REPORT_PRODUCTION" "J-学习"
...
test_intent "获取秤设备数据" "SCALE_LIST_DEVICES" "J-学习"
...
test_intent "显示所有告警记录" "ALERT_LIST" "J-学习"

# J016-030: 中置信度匹配 (15)
test_intent "机器状态怎样" "EQUIPMENT_STATS" "J-学习"
...
test_intent "告警事件处理记录" "ALERT_LIST" "J-反馈"
...
test_intent "设备维护保养计划" "EQUIPMENT_MAINTENANCE" "J-反馈"

# J041-050: 用户负向反馈 (10)
test_intent "机台运转情况" "EQUIPMENT_STATS" "J-反馈"
...
test_intent "异常报警汇总" "ALERT_LIST" "J-反馈"
test_intent "电子秤读数记录" "SCALE_LIST_DEVICES" "J-反馈"
test_intent "产能利用率报告" "REPORT_PRODUCTION" "J-反馈"
test_intent "原料消耗预警" "MATERIAL_LOW_STOCK_ALERT" "J-反馈"
test_intent "设备保修记录" "EQUIPMENT_MAINTENANCE" "J-反馈"
...
# K001-010: 配置回滚 (10)
test_intent "设备运维管理" "EQUIPMENT_MAINTENANCE" "K-版本"
...
test_intent "设备健康监测" "EQUIPMENT_STATS" "K-版本"
...
test_intent "预警监控平台" "ALERT_LIST" "K-版本"
