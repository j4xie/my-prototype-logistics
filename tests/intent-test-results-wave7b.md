...
--- AA11: 方言-地方化表达 (5) ---
  I [QUERY   ] QUERY_INVENTORY_TOTAL          PHRASE_MATCH 0.98 | 仓库里头还有好多货伐
...
--- AB13: 订单取消-取消vs删除精确区分 (6) ---
  ...
  V [WRITE   ] ORDER_DELETE                   SEMANTIC     0.85 | 永久删除订单记录
...
--- AH2: 发货-按日期/更新 (5) ---
  ...
  V [WRITE   ] SHIPMENT_CREATE                CLASSIFIER   0.97 | 更新这条发货单信息
...
--- AI4: 拼写错误-发货订单HR (5) ---
  I [QUERY   ] SOP_ANALYZE_COMPLEXITY         SEMANTIC     0.98 | 发或记录
  V [QUERY   ] ORDER_LIST                     PHRASE_MATCH 0.98 | 订单逾其了
  V [QUERY   ] ATTENDANCE_HISTORY             CLASSIFIER   0.98 | 考勤已常记录
  X [UNMATCHED] N/A                            ?            ? | 帮我打咔
  I [QUERY   ] TRACE_CODE_FORMAT              SEMANTIC     0.90 | 排版表
  === AI4: intent=3/5, type=5/5
...
--- AN1: 多轮-接上条/继续查 (6) ---
  X [UNMATCHED] N/A                            ?            ? | 接上条
  I [QUERY   ] QUERY_PROCESSING_CURRENT_STEP  SEMANTIC     0.83 | 刚才那个继续查
...
--- AN3: 多轮-确认/否定/修正上文 (5) ---
  I [QUERY   ] ORDER_LIST                     SEMANTIC     0.97 | 对就是这个再查详细一点
...
--- AP3: 数字-多数值组合查询 (5) ---
  ...
  V [QUERY   ] QUALITY_CHECK_QUERY            CLASSIFIER   0.99 | 查看批次号B001到B010的质检
...
--- AS2: 情绪-紧急恐慌 (5) ---
  ...
  V [QUERY   ] SHIPMENT_BY_CUSTOMER           CLASSIFIER   0.99 | 客户催了三次了赶紧查发货
...
--- AS3: 情绪-阴阳怪气/委婉攻击 (5) ---
  ...
  V [QUERY   ] SHIPMENT_QUERY                 SEMANTIC     1.00 | 都第三次问了请问订单到底发了没
...
--- AX5: 流水账混合多意图句 (4) ---
  ...
  I [QUERY   ] REPORT_EFFICIENCY              SEMANTIC     0.99 | 看看今天产量顺便把质检报告拉出来再安排明天排班
  V [QUERY   ] ATTENDANCE_STATUS              PHRASE_MATCH 0.98 | 张三打卡了吗如果没来就安排李四顶班然后告诉车间主管
  I [QUERY   ] CONTEXT_CONTINUE               SEMANTIC     0.95 | 检查设备状态把坏的报修同时催一下维修进度
...
--- T4: 对抗-跨域连词bypass (3) ---
  ...
  I [QUERY   ] REPORT_INVENTORY               SEMANTIC     0.99 | 查完订单再看员工绩效
...
--- W3: 边界-否定句式 (5) ---
  ...
  V [QUERY   ] REPORT_PRODUCTION              CLASSIFIER   0.98 | 别查生产，看看设备
...
--- Z1: 上下文-代词回指 (5) ---
  ...
  T [UNKNOWN ] MEDIA_PLAY                     SEMANTIC     0.87 | 再查一下那个供应商
...
======================================================================
Intent accuracy:  1194/1232 (97%)
Type accuracy:    1148/1232 (93%)

!!! 84 TYPE CONFUSIONS (cross-contamination) !!!
  ...
  [Z1] "再查一下那个供应商" expected=QUERY actual=UNKNOWN intent=MEDIA_PLAY (再查一下+供应商)
  [Z2] "按部门拆分看看" expected=QUERY actual=UNKNOWN intent=CAMERA_UNSUBSCRIBE (拆分=维度)

--- 38 Intent Mismatches ---
  [AA11] [PHRASE_MATCH] "仓库里头还有好多货伐" -> QUERY_INVENTORY_TOTAL, expected: MATERIAL_BATCH_QUERY|REPORT_INVENTORY|INVENTORY_SUMMARY_QUERY|REPORT_DASHBOARD_OVERVIEW|N/A (上海话-伐)
  ...
  [AI4] [SEMANTIC] "发或记录" -> SOP_ANALYZE_COMPLEXITY, expected: SHIPMENT_QUERY|SHIPMENT_STATS|ORDER_LIST|N/A (货→或(同音typo))
  [AI4] [SEMANTIC] "排版表" -> TRACE_CODE_FORMAT, expected: SCHEDULING_LIST|SCHEDULING_COVERAGE_QUERY|N/A (班→版(同音typo))
  ...
  [AN1] [SEMANTIC] "刚才那个继续查" -> QUERY_PROCESSING_CURRENT_STEP, expected: CONTEXT_CONTINUE|REPORT_DASHBOARD_OVERVIEW|N/A (接续-刚才继续)
  ...
  [AN3] [SEMANTIC] "对就是这个再查详细一点" -> ORDER_LIST, expected: CONTEXT_CONTINUE|QUERY_GENERIC_DETAIL|PROCESSING_BATCH_DETAIL|N/A (确认+追查)
  ...
  [AX5] [SEMANTIC] "看看今天产量顺便把质检报告拉出来再安排明天排班" -> REPORT_EFFICIENCY, expected: PRODUCTION_STATUS_QUERY|REPORT_PRODUCTION|QUALITY_CHECK_QUERY|SCHEDULING_EXECUTE_FOR_DATE|N/A (三意图-产量+质检+排班)
  [AX5] [SEMANTIC] "检查设备状态把坏的报修同时催一下维修进度" -> CONTEXT_CONTINUE, expected: EQUIPMENT_STATUS_QUERY|EQUIPMENT_STATUS_UPDATE|ALERT_DIAGNOSE|SHIPMENT_EXPEDITE|N/A (三意图-设备+报修+催进度)
  ...
  [T4] [SEMANTIC] "查完订单再看员工绩效" -> REPORT_INVENTORY, expected: ORDER_LIST|QUERY_EMPLOYEE_PROFILE|REPORT_KPI|N/A (跨域可UNMATCHED)
  [Y1] [SEMANTIC] "采购订单和销售订单" -> REPORT_TRENDS, expected: ORDER_LIST|ORDER_LIST|REPORT_KPI|N/A (订单类型混淆,跨域可UNMATCHED)
  [Z1] [SEMANTIC] "再查一下那个供应商" -> MEDIA_PLAY, expected: SUPPLIER_SEARCH|SUPPLIER_LIST|SUPPLIER_EVALUATE|N/A (再查一下+供应商)
...
======================================================================
PHASE 2: Response Quality (16:02:43)
======================================================================
  ...
  ~ [QUERY  ] SHIPMENT_CREATE                | 今日发货     | WARN:status=NEED_MORE_INFO, OK:has_reply, WARN:no_data, OK:relevant(1/1kw)
  ...
  V [WRITE  ] CLOCK_OUT                      | 签退打卡     | OK:slot_filling, OK:has_reply, OK:has_data, OK:relevant(1/1kw)
    reply: 签退成功！您今天提前776分钟下班。今日工作时长：-3.9小时。
...
--- Phase 2 Summary ---
Total: 94 | PASS: 77 | WARN: 17 | FAIL: 0
Pass rate: 77/94 (82%) full-pass
...
FINAL SUMMARY
======================================================================
Phase 1 - Intent Routing:  1194/1232 (97%)
Phase 1 - Type Separation: 1148/1232 (93%)
Phase 1 - Cross-contamination: 84 cases
Phase 2 - Response Quality: 77/94 full-pass, 94/94 acceptable
...
Started at 16:03:41
======================================================================
  ... 50/1232 done (16:03:48)
  ... 100/1232 done (16:03:52)
  ... 150/1232 done (16:03:58)
  ... 200/1232 done (16:04:05)
  ... 250/1232 done (16:04:10)
  ... 300/1232 done (16:04:15)
  ... 350/1232 done (16:04:19)
  ... 400/1232 done (16:04:24)
  ... 450/1232 done (16:04:28)
  ... 500/1232 done (16:04:31)
  ... 550/1232 done (16:04:35)
  ... 600/1232 done (16:04:39)
  ... 650/1232 done (16:04:42)
  ... 700/1232 done (16:04:46)
  ... 750/1232 done (16:04:49)
  ... 800/1232 done (16:04:53)
  ... 850/1232 done (16:04:56)
  ... 900/1232 done (16:04:59)
  ... 950/1232 done (16:05:03)
  ... 1000/1232 done (16:05:06)
  ... 1050/1232 done (16:05:11)
  ... 1100/1232 done (16:05:14)
  ... 1150/1232 done (16:05:18)
  ... 1200/1232 done (16:05:21)
  Completed all 1232 at 16:05:25
...
--- Per-Category Quality ---
  ...
  AB2: 5/6 PASS, 0 WARN, 1 FAIL (83%) [话题句-话题述题结构] <<< FAIL
...
--- FAIL Cases (1) ---
  [AB2] "考勤嘛，帮我看看" → ERROR | status=ERROR | API_ERROR, STATUS_ERROR, NO_REPLY, SLOW(90s)
    reply: (empty)

--- Issue Distribution ---
  API_ERROR: 1 cases
  STATUS_ERROR: 1 cases
  NO_REPLY: 1 cases
  SLOW: 1 cases

--- Worst Intents (by quality issues) ---
  ERROR: 0/1 PASS (0%), 1 FAIL, 0 WARN

======================================================================
PHASE 2b SUMMARY: Full Quality Scan
======================================================================
Total: 1232 | PASS: 1231 (100%) | WARN: 0 | FAIL: 1
Acceptable (PASS+WARN): 1231/1232 (100%)
Categories needing attention: AB2
...
======================================================================
Phase 1  — Intent Routing:      1194/1232 (97%)
Phase 2  — Curated Quality:     77/94 full-pass, 94/94 acceptable
Phase 2b — Full Quality Scan:   1231/1232 full-pass (100%), 1231/1232 acceptable (100%)
