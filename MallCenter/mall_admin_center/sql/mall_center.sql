...
CREATE TABLE `goods_category` (
  ...
  `enable` char(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '（1：开启；0：关闭）',
...
-- ----------------------------
INSERT INTO `goods_category` VALUES ('1352217944631853057', '1', '0', 'JooLun', '', 'http://joolun-open.oss-cn-zhangjiakou.aliyuncs.com/joolun.png', '1', '2021-01-21 19:34:15', '2021-01-21 19:34:15', '0');
INSERT INTO `goods_category` VALUES ('1352217984268025858', '1', '1352217944631853057', 'JooLun二开源码', '', 'http://joolun-open.oss-cn-zhangjiakou.aliyuncs.com/Joolun_logo.png', '1', '2021-01-21 19:34:25', '2021-01-21 19:34:25', '0');
INSERT INTO `goods_category` VALUES ('1352218128409477121', '1', '0', '鞋包', '', 'http://joolun-open.oss-cn-zhangjiakou.aliyuncs.com/%E5%88%86%E7%B1%BB-%E7%AE%B1%E5%8C%85%E9%85%8D%E9%A5%B0.png', '4', '2021-01-21 19:34:59', '2021-01-21 19:34:59', '0');
INSERT INTO `goods_category` VALUES ('1353731419288924162', '1', '0', '手机', '', 'http://joolun-open.oss-cn-zhangjiakou.aliyuncs.com/%E5%88%86%E7%B1%BB-%E6%89%8B%E6%9C%BA.png', '2', '2021-01-25 23:48:16', '2021-01-25 23:48:16', '0');
INSERT INTO `goods_category` VALUES ('1355427201956208642', '1', '1353731419288924162', 'iPhone', '', 'http://joolun-open.oss-cn-zhangjiakou.aliyuncs.com/10952adc-cad0-4c53-8762-9906d1dde220.jpg', '1', '2021-01-30 16:06:42', '2021-01-30 16:06:42', '0');
INSERT INTO `goods_category` VALUES ('1356512975786287105', '1', '1353731419288924162', 'Huawei', '', 'http://joolun-open.oss-cn-zhangjiakou.aliyuncs.com/goods-5.png', '2', '2021-02-02 16:01:11', '2021-02-02 16:01:11', '0');
INSERT INTO `goods_category` VALUES ('1356950418000826369', '1', '0', '服饰', '', 'http://joolun-open.oss-cn-zhangjiakou.aliyuncs.com/%E5%88%86%E7%B1%BB-%E6%9C%8D%E9%A5%B0.png', '5', '2021-02-03 20:59:25', '2021-02-03 20:59:25', '0');
INSERT INTO `goods_category` VALUES ('1356973226344960001', '1', '0', '电脑', '', 'http://joolun-open.oss-cn-zhangjiakou.aliyuncs.com/%E5%88%86%E7%B1%BB-%E7%94%B5%E8%84%91.png', '3', '2021-02-03 22:30:03', '2021-02-03 22:30:03', '0');
INSERT INTO `goods_category` VALUES ('1366609186567565314', '1', '0', 'Joolun', '', 'https://joolun-open.oss-cn-zhangjiakou.aliyuncs.com/joolun.png', '0', '2021-03-02 12:39:55', '2021-03-02 12:39:55', '0');
INSERT INTO `goods_category` VALUES ('1366628215470501890', '1', '1366609186567565314', 'Uniapp 多店版', '', 'https://joolun-open.oss-cn-zhangjiakou.aliyuncs.com/goods-14.png', '1', '2021-03-02 13:55:31', '2021-03-02 13:55:31', '0');
INSERT INTO `goods_category` VALUES ('1366628362271141890', '1', '1366609186567565314', '小程序商城版', '', 'https://joolun-open.oss-cn-zhangjiakou.aliyuncs.com/goods-17.png', '2', '2021-03-02 13:56:06', '2021-03-02 13:56:06', '0');
...
CREATE TABLE `order_info` (
  ...
  `payment_way` char(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '支付方式1、货到付款；2、在线支付',
  `is_pay` char(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '是否支付0、未支付 1、已支付',
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '订单名',
  ...
  `transaction_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '支付交易ID',
  `logistics_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '物流id',
...
CREATE TABLE `order_item` (
  ...
  `is_refund` char(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '0' COMMENT '是否退款0:否 1：是',
  PRIMARY KEY (`id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=119 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统访问记录';
...
INSERT INTO `sys_logininfor` VALUES ('107', 'superAdmin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', '1', '用户不存在/密码错误', '2025-12-24 14:53:45');
INSERT INTO `sys_logininfor` VALUES ('108', 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', '1', '用户不存在/密码错误', '2025-12-24 14:55:04');
INSERT INTO `sys_logininfor` VALUES ('109', 'test', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', '1', '验证码错误', '2025-12-24 14:56:00');
INSERT INTO `sys_logininfor` VALUES ('110', 'test', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', '1', '用户不存在/密码错误', '2025-12-24 14:56:03');
INSERT INTO `sys_logininfor` VALUES ('111', 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', '1', '用户不存在/密码错误', '2025-12-24 14:57:18');
INSERT INTO `sys_logininfor` VALUES ('112', 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', '1', '验证码错误', '2025-12-24 14:57:32');
INSERT INTO `sys_logininfor` VALUES ('113', 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', '1', '用户不存在/密码错误', '2025-12-24 14:59:45');
INSERT INTO `sys_logininfor` VALUES ('114', 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', '1', '用户不存在/密码错误', '2025-12-24 15:01:01');
INSERT INTO `sys_logininfor` VALUES ('115', 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', '1', '验证码错误', '2025-12-24 15:01:15');
INSERT INTO `sys_logininfor` VALUES ('116', 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', '0', '登录成功', '2025-12-24 15:01:19');
INSERT INTO `sys_logininfor` VALUES ('117', 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', '0', '退出成功', '2025-12-24 15:01:44');
INSERT INTO `sys_logininfor` VALUES ('118', 'admin', '127.0.0.1', '内网IP', 'Chrome 13', 'Windows 10', '0', '登录成功', '2025-12-24 15:01:52');
...
INSERT INTO `sys_menu` VALUES ('4', '公众号管理', '0', '4', 'wxmp', null, '', '', '1', '0', 'M', '0', '0', '', 'wechat', 'admin', '2024-09-11 09:31:31', '', null, '公众号管理');
...
INSERT INTO `sys_menu` VALUES ('2049', '小程序管理', '0', '3', 'wxma', null, null, '', '1', '0', 'M', '0', '0', null, 'phone', 'admin', '2021-01-28 23:45:03', '', null, '');
...
-- ----------------------------
INSERT INTO `sys_oper_log` VALUES ('100', '个人信息', '2', 'com.joolun.web.controller.system.SysProfileController.updatePwd()', 'PUT', '1', 'admin', '研发部门', '/system/user/profile/updatePwd', '127.0.0.1', '内网IP', '{}', '{\"msg\":\"操作成功\",\"code\":200}', '0', null, '2025-12-24 15:01:40', '245');
...
CREATE TABLE `wx_auto_reply` (
  ...
  `content` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci COMMENT '图文消息的内容',
  PRIMARY KEY (`id`)
...
CREATE TABLE `wx_user` (
  ...
  `del_flag` char(2) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT '0' COMMENT '逻辑删除标记（0：显示；1：隐藏）',
  `app_type` char(2) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '应用类型(1:小程序，2:公众号)',
  `subscribe` char(2) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '是否订阅（1：是；0：否；2：网页授权用户）',
  `subscribe_scene` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '返回用户关注的渠道来源，ADD_SCENE_SEARCH 公众号搜索，ADD_SCENE_ACCOUNT_MIGRATION 公众号迁移，ADD_SCENE_PROFILE_CARD 名片分享，ADD_SCENE_QR_CODE 扫描二维码，ADD_SCENEPROFILE LINK 图文页内名称点击，ADD_SCENE_PROFILE_ITEM 图文页右上角菜单，ADD_SCENE_PAID 支付后关注，ADD_SCENE_OTHERS 其他',
  ...
  `qr_scene_str` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '二维码扫码场景',
  ...
  `session_key` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL COMMENT '会话密钥',
  PRIMARY KEY (`id`),
