...
- 2026-05-09: ``_java_string_hashcode`` + ``_JavaRandom`` added as Day-0
  ...
  mock-data mirroring (PR #199 §3 / PR #203 §8.9).
- 2026-05-12: ``_JavaRandom`` + ``_java_string_hashcode`` REMOVED per Steve
  verbal sign-off (AskUserQuestion 2026-05-12). Q1 amendment (PR #223)
  selected real-DB binding for T6.6 Sub-A/Sub-B production + quality
  endpoint impl — mock-data generators no longer needed. Reference fixture
  ``tests/fixtures/JavaRandomReferenceDump.java`` also removed.
...
# _JavaRandom + _java_string_hashcode removed 2026-05-12 (Steve verbal sign-off).
# Q1 amendment (PR #223) selected real-DB binding for T6.6 Sub-A/B impl — mock
# data generators no longer needed. See git history for original implementation.
