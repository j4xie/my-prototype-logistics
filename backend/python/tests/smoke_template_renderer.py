...
_SALES_ORDER_SCHEMA = {
    ...
    "elements": [
        ...
        },
        {
            ...
            "x": 50,
            "y": 175,
            "binding": "{{format.date(order.orderDate, 'YYYY-MM-DD')}}",
            "fontSize": 12,
        },
        {"id": "customer", "type": "field", "x": 50, "y": 200, "binding": "{{order.customerName}}", "fontSize": 12},
        {
            ...
            "x": 50,
            "y": 225,
            "binding": "{{format.currency(order.totalAmount)}}",
            "fontSize": 14,
            "bold": True,
            "color": "#dc2626",
        },
...
_WEIGHING_SLIP_SCHEMA = {
    ...
    "elements": [
        ...
        {"id": "product", "type": "field", "x": 50, "y": 125, "binding": "产品: {{slip.productName}}", "fontSize": 11},
        {
            ...
            "x": 50,
            "y": 145,
            "binding": "客户/供应商: {{slip.partnerName}}",
            "fontSize": 11,
        },
        {
            "id": "weighDate",
            ...
            "x": 50,
            "y": 165,
            "binding": "过磅日期: {{format.date(slip.weighDate)}}",
            "fontSize": 11,
        },
        {"id": "operator", "type": "field", "x": 50, "y": 185, "binding": "操作员: {{slip.operator}}", "fontSize": 11},
        {
            ...
            "y": 220,
            "binding": (
                "总毛重: {{format.qty(slip.grossWeight)}} kg  |  "
                "总皮重: {{format.qty(slip.tareWeight)}} kg  |  "
                "总净重: {{format.qty(slip.netWeight)}} kg"
            ),
            "fontSize": 12,
            "bold": True,
            "color": "#dc2626",
    ...
    return {
        ...
        "elements": [
            ...
            },
            {
                ...
                "x": 50,
                "y": 160,
                "text": "(Day 5 smoke — minimal schema)",
                "fontSize": 10,
                "color": "#9ca3af",
            },
        ],
