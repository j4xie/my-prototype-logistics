...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='APS排程任务表';
...
-- 预测信息
CALL add_column_if_not_exists_v2026('aps_schedule_task', 'predicted_end', "DATETIME COMMENT '预测完成时间'");
...
CALL add_column_if_not_exists_v2026('aps_schedule_task', 'last_adjustment_time', "DATETIME COMMENT '最后调整时间'");
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='效率历史记录表';
...
CREATE TABLE IF NOT EXISTS aps_weight_history (
    ...
    adjusted_at DATETIME NOT NULL COMMENT '调整时间',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='策略权重调整历史';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='AI Agent 规则配置表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='SKU复杂度表';
...
INSERT IGNORE INTO ai_agent_rules (
    id,
    factory_id,
    trigger_type,
    trigger_entity,
