...
CALL add_column_if_not_exists('line_schedules', 'predicted_end', "DATETIME COMMENT '预测完成时间'");
...
CALL add_column_if_not_exists('line_schedules', 'last_adjustment_time', "DATETIME COMMENT '最后调整时间'");
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='完成概率预测模型权重';
...
INSERT IGNORE INTO aps_prediction_model_weights (id, factory_id, feature_name, feature_weight) VALUES
