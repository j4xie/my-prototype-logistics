...
-- NOTE: All chains are DISABLED by default. SupplyChainOrchestrator handles these events
-- via hardcoded @EventListener. Enable chains per-factory via Canvas UI to switch from
-- hardcoded to configurable orchestration. This prevents double-fire or silent event loss.
...
VALUES (NULL, 'SO_FINANCE_APPROVED', 'SalesOrderFinanceApprovedEvent', false,
...
INSERT INTO factory_trigger_chains (factory_id, chain_code, event_type, enabled, steps, error_strategy, description)
VALUES (NULL, 'BATCH_COMPLETED', 'BatchCompletedEvent', false,
...
INSERT INTO factory_trigger_chains (factory_id, chain_code, event_type, enabled, steps, error_strategy, description)
VALUES (NULL, 'MATERIAL_RECEIVED', 'MaterialReceivedEvent', false,
...
INSERT INTO factory_trigger_chains (factory_id, chain_code, event_type, enabled, steps, error_strategy, description)
VALUES (NULL, 'SO_CONFIRMED', 'SalesOrderConfirmedEvent', false,
'[]'::jsonb,
