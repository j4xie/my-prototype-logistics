...
CREATE TABLE IF NOT EXISTS worker_feature_profile (
    ...
    -- 疲劳特征
    fatigue_decay_rate DOUBLE DEFAULT 0.05 COMMENT '每小时疲劳衰减率',
    optimal_work_hours DOUBLE DEFAULT 6.0 COMMENT '最佳工作时长',

    -- 技能特征
    skill_growth_rate DOUBLE DEFAULT 0.0 COMMENT '技能成长率(每周)',
    ...
    confidence_score DOUBLE DEFAULT 0.5 COMMENT '特征置信度',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='工人特征画像表';
...
CREATE TABLE IF NOT EXISTS sku_feature_profile (
    ...
    -- 复杂度 (自动学习)
    learned_complexity DOUBLE DEFAULT 3.0 COMMENT '学习得到的复杂度',
    ...
    avg_efficiency DOUBLE DEFAULT 0.0 COMMENT '历史平均效率',
    failure_rate DOUBLE DEFAULT 0.0 COMMENT '失败率',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='SKU特征画像表';
...
CREATE TABLE IF NOT EXISTS fair_mab_virtual_queue (
    ...
    -- 虚拟队列状态
    queue_length DOUBLE DEFAULT 0.0 COMMENT '虚拟队列长度(公平性债务)',
    target_ratio DOUBLE DEFAULT 0.0 COMMENT '目标分配比例',
    actual_ratio DOUBLE DEFAULT 0.0 COMMENT '实际分配比例',
    ...
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    period_start_at DATETIME NULL COMMENT '统计周期开始时间',

    UNIQUE KEY uk_factory_worker (factory_id, worker_id),
    INDEX idx_queue_length (factory_id, queue_length DESC)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='公平性MAB虚拟队列表';
...
CREATE TABLE IF NOT EXISTS scheduling_feature_drift_log (
    ...
    drift_magnitude DOUBLE NULL COMMENT '漂移幅度',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='特征漂移日志表';
