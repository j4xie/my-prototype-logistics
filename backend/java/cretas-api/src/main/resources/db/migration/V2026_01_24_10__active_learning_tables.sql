...
CREATE TABLE IF NOT EXISTS active_learning_samples (
    ...
    input_embedding BLOB COMMENT '输入的向量嵌入 (可选)',
    ...
    learned_at DATETIME COMMENT '学习完成时间',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='低置信度样本存储表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='意图转移概率矩阵表';
...
CREATE TABLE IF NOT EXISTS cross_factory_knowledge (
    ...
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    promoted_at DATETIME COMMENT '推广为全局时间',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='跨工厂知识库表';
...
CREATE TABLE IF NOT EXISTS cross_factory_knowledge_adoption (
    ...
    -- 采用信息
    adopted_at DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT '采用时间',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='跨工厂知识采用记录表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='学习任务队列表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='模型性能日志表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='人工标注队列表';
...
CREATE TABLE IF NOT EXISTS sample_clusters (
    ...
    -- 聚类信息
    cluster_label VARCHAR(200) COMMENT '聚类标签/描述',
    cluster_centroid BLOB COMMENT '聚类中心向量',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='样本聚类结果表';
