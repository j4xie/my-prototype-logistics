...
CREATE TABLE IF NOT EXISTS keyword_factory_adoption (
  ...
  promoted_at DATETIME NULL COMMENT '晋升时间',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='跨工厂关键词采用表';
...
CREATE TABLE IF NOT EXISTS keyword_promotion_history (
  ...
  -- 审计字段
  promoted_at DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT '晋升时间',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='关键词晋升历史表';
