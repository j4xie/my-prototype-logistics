...
-- Original file: V2025_12_29_8__add_production_plan_approval_fields.sql
-- Conversion date: 2026-01-26 18:46:05
-- ============================================
...
ALTER TABLE production_plans
    ...
    ADD COLUMN approved_at TIMESTAMP WITH TIME ZONE COMMENT '审批时间',
    ...
    ADD COLUMN force_inserted_at TIMESTAMP WITH TIME ZONE COMMENT '强制插单时间';
