...
-- Original file: V2026_01_06_10__fix_isapi_equipment_id_type.sql
-- Conversion date: 2026-01-26 18:47:46
-- ============================================
...
ALTER TABLE isapi_devices
    ALTER COLUMN equipment_id TYPE BIGINT NULL COMMENT '关联设备ID (factory_equipment.id)';
