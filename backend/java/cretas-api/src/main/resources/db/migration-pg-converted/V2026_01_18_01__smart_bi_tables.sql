...
-- Original file: V2026_01_18_01__smart_bi_tables.sql
-- Conversion date: 2026-01-26 18:48:40
...
CREATE TABLE IF NOT EXISTS smart_bi_analysis_cache (
    ...
    expires_at TIMESTAMP WITH TIME ZONE COMMENT 'Cache expiration time',
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
    deleted_at TIMESTAMP WITH TIME ZONE NULL,
...
INSERT INTO smart_bi_billing_config (factory_id, billing_mode, daily_quota, price_per_query)
