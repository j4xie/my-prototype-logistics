...
-- Original file: V2026_01_03_5__factory_ai_learning_config.sql
-- Conversion date: 2026-01-26 18:47:05
...
CREATE TABLE IF NOT EXISTS factory_ai_learning_config (
  ...
  last_specificity_recalc_at TIMESTAMP WITH TIME ZONE NULL COMMENT '上次特异性重算时间',
