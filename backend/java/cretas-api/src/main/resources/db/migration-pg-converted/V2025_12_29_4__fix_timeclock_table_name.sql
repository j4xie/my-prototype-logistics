...
-- Original file: V2025_12_29_4__fix_timeclock_table_name.sql
-- Conversion date: 2026-01-26 18:45:58
-- ============================================
...
SET @sql_created = IF(
    @col_created = 0,
    'ALTER TABLE time_clock_records ADD COLUMN created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP',
...
SET @sql_updated = IF(
    @col_updated = 0,
    'ALTER TABLE time_clock_records ADD COLUMN updated_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP',
...
SET @sql_deleted = IF(
    @col_deleted = 0,
    'ALTER TABLE time_clock_records ADD COLUMN deleted_at TIMESTAMP WITH TIME ZONE NULL',
