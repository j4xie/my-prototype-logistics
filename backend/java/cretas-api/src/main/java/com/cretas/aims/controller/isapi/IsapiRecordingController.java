 ...
 *       角色暴露; 其他角色 (即便通过 L2 dynamic override 获得 {@code equipment:read_write})
...
public class IsapiRecordingController {
    ...
    public ApiResponse<Map<String, Object>> getPlaybackUrl(
        ...
        try {
            ...
            // factory_super_admin / equipment_admin。其他角色 (即便通过 L2 dynamic
            // override 获得 equipment:read_write) 也将强制降级到 includeAuth=false 路径。
