...
public class IntentSlotConfiguration {
    ...
    public void init() {
        ...
        // 完整生产计划创建（含产线、工人、主管）
        registerSlots("PRODUCTION_PLAN_CREATE_FULL", Arrays.asList(
                RequiredSlot.builder()
                        .name("productId")
                        .label("产品")
                        .type("TEXT")
                        .required(true)
                        .validationHint("请问要生产什么产品？")
                        .priority(1)
                        .autoFillFromContext(true)
                        .entityType("PRODUCT")
                        .build(),
