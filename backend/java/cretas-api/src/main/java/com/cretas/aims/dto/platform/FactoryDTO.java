...
public class FactoryDTO {
    ...
    @Schema(description = "组织类型", example = "FACTORY", allowableValues = {"FACTORY", "RESTAURANT", "HEADQUARTERS", "BRANCH", "CENTRAL_KITCHEN"})
    private String type;

    @Schema(description = "上级组织ID", example = "HQ001")
    private String parentId;

    @Schema(description = "组织层级: 0=独立 1=总部 2=区域 3=门店", example = "0")
    private Integer level;

    @Schema(description = "组织类型显示名称", example = "工厂")
