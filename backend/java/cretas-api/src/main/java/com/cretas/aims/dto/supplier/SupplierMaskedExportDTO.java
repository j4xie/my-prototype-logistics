...
/**
 * RBAC-masked variant of {@link SupplierExportDTO} for export to users lacking
 * {@code procurement:price:view} permission.
 *
 * <p>Mirrors column structure 1:1 but renders {@code creditLimit} (col 9) as
 * {@code String} so the placeholder "—" can be written instead of a numeric value.
 *
...
@HeadRowHeight(20)
@ContentRowHeight(18)
public class SupplierMaskedExportDTO {
    ...
    public static SupplierMaskedExportDTO fromSupplierDTO(SupplierDTO dto) {
        if (dto == null) {
            return null;
        }
        return SupplierMaskedExportDTO.builder()
