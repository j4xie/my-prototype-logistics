...
```bash
# 复制到服务器
scp -r models/incremental/final root@139.196.165.140:/www/wwwroot/python-services/models/chinese-roberta-wwm-ext-classifier/

# 重启 Python 服务
ssh root@139.196.165.140 "systemctl restart python-services"
```
