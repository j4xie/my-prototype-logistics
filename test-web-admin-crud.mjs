/**
 * Web-Admin Layer 2 CRUD E2E Test
 ...
 *
 * Run: node test-web-admin-crud.mjs
...
(async () => {
  console.log('=== Web-Admin CRUD E2E Tests ===');
      ...
      try {
        ...
        if (ct.includes('json') && ['POST', 'PUT'].includes(resp.request().method())) {
          ...
          if (!body?.success) {
            ...
            console.log(`  [API ERROR] ${resp.request().method()} ${url.replace('http://localhost:5173', '')} => ${resp.status()}: ${lastApiError}`);
          }
        }
      } catch { /* ignore */ }
    }
  ...
  try {
    ...
    await page.goto(`${BASE}/sales/customers`, { waitUntil: 'networkidle', timeout: 10000 });
  ...
  try {
    await dismissToasts(page);
    await page.goto(`${BASE}/sales/orders`, { waitUntil: 'networkidle', timeout: 10000 });
    await page.waitForTimeout(1500);
  ...
  try {
    await dismissToasts(page);
    await page.goto(`${BASE}/procurement/suppliers`, { waitUntil: 'networkidle', timeout: 10000 });
    await page.waitForTimeout(1500);
  ...
  try {
    await dismissToasts(page);
    await page.goto(`${BASE}/procurement/orders`, { waitUntil: 'networkidle', timeout: 10000 });
    await page.waitForTimeout(1500);
  ...
  try {
    await dismissToasts(page);
    await page.goto(`${BASE}/production/batches`, { waitUntil: 'networkidle', timeout: 10000 });
    await page.waitForTimeout(1500);
  ...
  try {
    await dismissToasts(page);
    await page.goto(`${BASE}/production/plans`, { waitUntil: 'networkidle', timeout: 10000 });
    await page.waitForTimeout(1500);
  ...
  try {
    await dismissToasts(page);
    await page.goto(`${BASE}/warehouse/materials`, { waitUntil: 'networkidle', timeout: 10000 });
    await page.waitForTimeout(1500);
  ...
  try {
    await dismissToasts(page);
    await page.goto(`${BASE}/quality/inspections`, { waitUntil: 'networkidle', timeout: 10000 });
    await page.waitForTimeout(1500);
  ...
  try {
    await dismissToasts(page);
    await page.goto(`${BASE}/system/users`, { waitUntil: 'networkidle', timeout: 10000 });
    await page.waitForTimeout(1500);
  ...
  try {
    await dismissToasts(page);
    await page.goto(`${BASE}/rd/samples`, { waitUntil: 'networkidle', timeout: 10000 });
    await page.waitForTimeout(1500);
