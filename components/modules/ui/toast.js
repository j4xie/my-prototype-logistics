...
// 便捷方法
export const showToast = (message, type = 'info', duration) => traceToast.show(message, type, duration);
export const showInfo = (message, duration) => traceToast.show(message, 'info', duration);
export const showSuccess = (message, duration) => traceToast.show(message, 'success', duration);
export const showWarning = (message, duration) => traceToast.show(message, 'warning', duration);
export const showError = (message, duration) => traceToast.show(message, 'error', duration);
export const showLoading = (message = '加载中...', duration = 0) => traceToast.show(message, 'loading', duration);
