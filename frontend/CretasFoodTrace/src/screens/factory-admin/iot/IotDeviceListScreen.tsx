...
// 临时类型定义，后续需要添加到 navigation 类型文件
...
type NavigationProp = NativeStackNavigationProp<IotStackParamList, 'IotDeviceList'>;

export function IotDeviceListScreen() {
  ...
  const renderDeviceItem = ({ item }: { item: ScaleDevice }) => (
    <TouchableOpacity
      ...
      onPress={() => navigation.navigate('IotDeviceDetail', { deviceId: item.id })}
      activeOpacity={0.7}
    >
...
export default IotDeviceListScreen;
