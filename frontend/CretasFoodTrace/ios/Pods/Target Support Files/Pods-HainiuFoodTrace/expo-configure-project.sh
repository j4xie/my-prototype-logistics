...
with_node \
  ...
  --target "/Users/jietaoxie/my-prototype-logistics/frontend/HainiuFoodTrace/ios/Pods/Target Support Files/Pods-HainiuFoodTrace/ExpoModulesProvider.swift" \
  --entitlement "/Users/jietaoxie/my-prototype-logistics/frontend/HainiuFoodTrace/ios/HainiuFoodTrace/HainiuFoodTrace.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-barcode-scanner" "expo-constants" "expo-device" "expo-file-system" "expo-font" "expo-image-manipulator" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-local-authentication" "expo-location" "expo-notifications" "expo-secure-store" "expo-sharing"
