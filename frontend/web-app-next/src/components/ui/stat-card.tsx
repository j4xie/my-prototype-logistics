    ...
    return (
      <div
        ...
        className={cn(
          ...
          // 交互样式
          onClick &&
            'cursor-pointer transition-all duration-200 hover:scale-[1.03] hover:shadow-md',
          // 加载状态
          loading && 'opacity-60',
          className
        )}
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <div className="min-w-0 flex-1">
            <p className="mb-1 truncate text-sm text-gray-600" title={title}>
              {title}
            </p>
            ...
            {loading ? (
              ...
              <div className="flex items-baseline gap-2">
                ...
                {trend && (
                  ...
                  >
                    <i
                      className={cn('fas', trendIcons[trend.direction])}
                      aria-hidden="true"
                    />
          ...
          <div
            className={cn(
              'ml-3 flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-lg',
              colorClasses[color]
            )}
          >
            {loading ? (
