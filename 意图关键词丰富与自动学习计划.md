...
| 文件 | 改动类型 | 说明 |
|------|----------|------|
| `V2026_01_03_3__keyword_effectiveness.sql` | 新增 | 关键词效果追踪表 |
| `V2026_01_03_4__keyword_factory_adoption.sql` | 新增 | 跨工厂采用追踪表 |
| `V2026_01_03_5__factory_learning_status.sql` | 新增 | 工厂学习状态表 |
| `V2026_01_03_6__factory_ai_learning_config.sql` | 新增 | 工厂级动态配置表 |
| `KeywordEffectiveness.java` | 新增 | 关键词效果追踪实体 |
| `KeywordFactoryAdoption.java` | 新增 | 跨工厂采用记录实体 |
| `FactoryIntentLearningStatus.java` | 新增 | 工厂学习状态实体 |
| `FactoryAILearningConfig.java` | 新增 | 工厂级配置实体 |
...
| 配置项 | 默认值 | 说明 |
|--------|--------|------|
| `cretas.ai.intent.cleanup.min-effectiveness` | 0.3 | 清理阈值 |
| `cretas.ai.intent.cleanup.min-negative-count` | 5 | 最小负反馈数 |
| `cretas.ai.intent.promotion.enabled` | true | 晋升开关 |
| `cretas.ai.intent.promotion.min-factories` | 3 | 至少N个工厂采用 |
| `cretas.ai.intent.promotion.min-avg-score` | 0.8 | 平均有效分数阈值 |
