...
INSERT INTO equipment_alerts (factory_id, equipment_id, alert_type, level, status, message, triggered_at, created_at, updated_at) VALUES
-- F002的告警
('F002', @eq_f002_001, '温度异常', 'WARNING', 'ACTIVE', '速冻设备温度超出正常范围，当前温度-15℃，建议检查制冷系统', '2025-11-20 14:30:00', NOW(), NOW()),
('F002', @eq_f002_002, '维护提醒', 'INFO', 'ACTIVE', '真空包装机已运行2000小时，建议进行例行保养', '2025-11-21 09:00:00', NOW(), NOW()),
('F002', @eq_f002_003, '刀片磨损', 'CRITICAL', 'ACTIVE', '切割设备刀片磨损严重，请立即更换', '2025-11-22 16:45:00', NOW(), NOW()),

-- F003的告警
('F003', @eq_f003_001, '电力异常', 'WARNING', 'ACTIVE', '冷藏库设备电压不稳定，建议检查电路', '2025-11-20 11:20:00', NOW(), NOW()),
('F003', @eq_f003_002, '传感器故障', 'CRITICAL', 'RESOLVED', '分拣设备传感器失灵，已更换', '2025-11-19 08:15:00', NOW(), NOW()),
('F003', @eq_f003_003, '水压不足', 'WARNING', 'ACKNOWLEDGED', '清洗设备水压低于标准值，正在处理', '2025-11-21 13:30:00', NOW(), NOW());
...
-- ===== 4. 为所有3个工厂添加设备使用记录 =====
-- 注意：这里假设生产批次已经存在，如果没有批次，equipment_id关联的production_batch_id可以为NULL
