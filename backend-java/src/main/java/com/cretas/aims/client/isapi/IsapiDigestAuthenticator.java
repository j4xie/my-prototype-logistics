...
/**
 * ISAPI Digest 认证拦截器 (RFC 2617)
 *
 * 海康威视 ISAPI 使用 HTTP Digest 认证:
 * - 算法: MD5
 * - QOP: auth
 ...
 */
@Slf4j
public class IsapiDigestAuthenticator implements Interceptor {
    ...
    public IsapiDigestAuthenticator(String username, String password) {
