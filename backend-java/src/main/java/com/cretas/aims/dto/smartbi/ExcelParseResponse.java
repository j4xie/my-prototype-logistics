...
public class ExcelParseResponse {
    ...
    /**
     * 表格类型（由 Python TableClassifier 识别）
     * 可选值: index, data, summary, metadata, pivot, time_series, unknown 等
     */
    ...
    /**
     * 推荐的图表类型列表（由 Python auto-parse 返回）
     * 例如: ["bar_comparison", "line_trend", "pie"]
     */
    private List<String> recommendedCharts;

    /**
     * 结构信息（由 Python StructureDetector 返回）
     */
    ...
    public static class StructureInfo {
         ...
         * 合并单元格数量
         */
        private Integer mergedCellsCount;
    }
