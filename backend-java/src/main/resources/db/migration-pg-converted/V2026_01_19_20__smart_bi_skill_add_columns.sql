...
-- Original file: V2026_01_19_20__smart_bi_skill_add_columns.sql
-- Conversion date: 2026-01-26 18:48:55
-- ============================================
...
ALTER TABLE smart_bi_skill
ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMP WITH TIME ZONE NULL COMMENT 'Soft delete timestamp' AFTER updated_at;
