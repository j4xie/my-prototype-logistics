...
-- Original file: V2026_01_17_01__parameter_extraction_rules.sql
-- Conversion date: 2026-01-26 18:48:37
...
CREATE TABLE IF NOT EXISTS ai_parameter_extraction_rules (
    ...
    is_verified SMALLINT(1) DEFAULT 0 COMMENT '是否已人工确认',
    is_active SMALLINT(1) DEFAULT 1 COMMENT '是否启用',
