...
-- Original file: V2026_01_14_03__add_role_theme_tables.sql
-- Conversion date: 2026-01-26 18:48:17
...
CREATE TABLE IF NOT EXISTS lowcode_role_theme (
    ...
    -- Status & Audit
    status SMALLINT DEFAULT 1 COMMENT 'Status: 0=inactive, 1=active',
