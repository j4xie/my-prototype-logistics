...
-- Original file: V2026_01_15_03__add_line_supervisor_tables.sql
-- Conversion date: 2026-01-26 18:48:33
...
CREATE TABLE IF NOT EXISTS production_line_supervisors (
    ...
    assigned_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP COMMENT '分配时间',
