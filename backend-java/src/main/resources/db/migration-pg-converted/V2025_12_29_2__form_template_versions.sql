...
-- Original file: V2025_12_29_2__form_template_versions.sql
-- Conversion date: 2026-01-26 18:45:55
...
CREATE TABLE IF NOT EXISTS form_template_versions (
    ...
    created_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP COMMENT '版本创建时间',
