...
-- Original file: V2026_01_22__aps_adaptive_optimization.sql
-- Conversion date: 2026-01-26 18:49:23
-- ============================================
...
CALL add_column_if_not_exists_v20260122('aps_efficiency_history', 'updated_at',
    "TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间'");

CALL add_column_if_not_exists_v20260122('aps_efficiency_history', 'deleted_at',
    "TIMESTAMP WITH TIME ZONE NULL COMMENT '软删除时间'");
