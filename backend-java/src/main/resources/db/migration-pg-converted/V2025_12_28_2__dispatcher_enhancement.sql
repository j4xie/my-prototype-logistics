...
-- Original file: V2025_12_28_2__dispatcher_enhancement.sql
-- Conversion date: 2026-01-26 18:45:52
...
BEGIN
    ...
    -- 获取当前最大工号
    SELECT COALESCE(MAX(CAST(employee_code AS)), 0) + 1 INTO next_code FROM users WHERE employee_code IS NOT NULL;
