...
-- Original file: V2026_01_21_10__ai_intent_config_align_entity.sql
-- Conversion date: 2026-01-26 18:49:17
-- ============================================
...
ALTER TABLE ai_intent_configs ADD COLUMN confidence_threshold DOUBLE PRECISION DEFAULT 0.6 COMMENT '置信度阈值 0-1之间';
