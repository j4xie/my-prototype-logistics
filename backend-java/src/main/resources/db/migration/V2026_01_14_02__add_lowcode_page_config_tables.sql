...
CREATE TABLE IF NOT EXISTS lowcode_page_config (
    ...
    -- Status and Version
    status TINYINT DEFAULT 0 COMMENT 'Status: 0=draft, 1=published',
    version INT DEFAULT 1 COMMENT 'Version number',
    ai_generated TINYINT DEFAULT 0 COMMENT 'AI generated: 0=no, 1=yes',
...
COMMENT='Lowcode page configuration table';
...
CREATE TABLE IF NOT EXISTS lowcode_component_definition (
    ...
    is_system TINYINT DEFAULT 1 COMMENT 'System component: 0=custom, 1=system',
...
COMMENT='Lowcode component definition table';
