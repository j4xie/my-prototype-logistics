...
CREATE TABLE IF NOT EXISTS factory_home_layout (
    ...
    -- 时段布局
    time_based_enabled TINYINT DEFAULT 0 COMMENT '是否启用时段布局: 0否 1是',
    ...
    last_suggestion_at DATETIME COMMENT '上次建议时间',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='工厂首页布局配置表';
...
CREATE TABLE IF NOT EXISTS app_decoration_session (
    ...
    status TINYINT DEFAULT 0 COMMENT '状态: 0处理中 1成功 2失败 3已应用',
    conversation_history JSON COMMENT '对话历史',
    clarification_needed TINYINT DEFAULT 0 COMMENT '是否需要澄清: 0否 1是',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='AI装饰会话表';
