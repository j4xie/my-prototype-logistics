...
MODIFY COLUMN production_batch_id BIGINT;
...
MODIFY COLUMN production_batch_id BIGINT NOT NULL;
...
-- 回滚脚本（如需回滚，请使用以下SQL）
-- ============================================================
-- ALTER TABLE material_consumptions MODIFY COLUMN production_batch_id VARCHAR(191);
-- ALTER TABLE quality_inspections MODIFY COLUMN production_batch_id VARCHAR(191) NOT NULL;
