...
COMMENT='秤协议配置表 - 支持多品牌秤的协议定义与解析规则';
...
ALTER TABLE factory_equipments
    ...
    ADD COLUMN IF NOT EXISTS last_weight_time DATETIME COMMENT '最后称重时间',
...
CREATE TABLE IF NOT EXISTS weighing_records (
    ...
    -- 时间戳
    weighed_at DATETIME NOT NULL COMMENT '称重时间',
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
