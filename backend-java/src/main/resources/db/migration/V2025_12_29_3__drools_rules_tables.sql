...
CREATE TABLE IF NOT EXISTS drools_rules (
    ...
    decision_table MEDIUMBLOB COMMENT 'Excel 决策表内容 (可选)',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Drools 规则定义表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='规则事件绑定表';
...
CREATE TABLE IF NOT EXISTS drools_rule_versions (
    ...
    rule_content TEXT NOT NULL COMMENT 'DRL 规则内容',
    decision_table MEDIUMBLOB COMMENT 'Excel 决策表内容',
